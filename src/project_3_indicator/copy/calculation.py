...
class CalculationHandler:
    ...
    def handle_calculation(self, molecule_name, method_name, basis_name,
                         ...
                         omega=None, scanning_props=None):
        """
        ...
        try:
            ...
            calc_info = self.db.get_calculation_info_by_params(
    ...
    def store_results(self, calc_id):
        ...
        try:
            ...
            files_to_check = [f"{calc_id}.log", "ontop.dat", "indicator_dynamic.dat"]
    ...
    def get_processed_results(self, calc_id):
        ...
        try:
            ...
            indicator_dynamic_df = None
            if (results_path / "indicator_dynamic.dat").exists():
                indicator_dynamic_df = pd.read_csv(
                    results_path / "indicator_dynamic.dat",
                    skipinitialspace=True
                )
            ...
            processed_results = {
                ...
                "geometry": geometry,
                "ontop_data": ontop_df,
                "indicator_dynamic_data": indicator_dynamic_df,
